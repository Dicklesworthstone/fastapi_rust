...
> HEAD: [`7616b83`](https://github.com/Dicklesworthstone/fastapi_rust/commit/7616b8377dfc93ab694fcd4b6f2b78fb39289c19)

### Server Connection Hardening (2026-03-07)

Major reliability pass on the TCP server's connection lifecycle, fixing multiple race conditions and panic-safety issues in `fastapi-http`:

- **RAII connection slot cleanup**: introduced `ConnectionSlotGuard` so connection slots are freed even if a task panics; guard is created *before* spawning the async task to prevent slot leaks ([`8b29fcb`](https://github.com/Dicklesworthstone/fastapi_rust/commit/8b29fcb89196c8a349f36c28d53c11bfd898a469), [`4a01487`](https://github.com/Dicklesworthstone/fastapi_rust/commit/4a01487a24b9d47f358035badfca0deaa357535b))
- **Panic catching in connection tasks**: wraps handler futures so panics produce a 500 response and clean drain instead of crashing the accept loop ([`24b7b94`](https://github.com/Dicklesworthstone/fastapi_rust/commit/24b7b94cdb7730d78d53384844cf5a55169d243e))
- **Shutdown-aware accept**: `poll_accept` now uses a timeout so the accept loop notices shutdown signals promptly instead of blocking forever ([`cf46b87`](https://github.com/Dicklesworthstone/fastapi_rust/commit/cf46b871d2f0b39a78ee56992e3eaf7972f0dbe4))
- **Race condition fix**: eliminated TOCTOU race in runtime task cleanup test ([`63d9778`](https://github.com/Dicklesworthstone/fastapi_rust/commit/63d9778976d951092cc5a3d8a27e16c6e7092087))
- **Refactor**: `serve_concurrent` now uses `RuntimeHandle::spawn` and exposes connection helpers for composability ([`04e3206`](https://github.com/Dicklesworthstone/fastapi_rust/commit/04e320647583dc5f143a34ee7d94fc80f1a3f5aa))
...
> **Diff from initial crates.io publish (v0.1.2)**: `d12a9de..1170506` (~120 commits)

Major hardening and feature release. All 8 workspace crates bumped to 0.2.0.

### WebSocket Support (RFC 6455) -- `bd-z09e`

Full RFC 6455 WebSocket protocol implementation, integrated into the App and server:

- **Protocol core**: upgrade handshake, binary frame codec, masking, fragmentation, text validation ([`8b2d273`](https://github.com/Dicklesworthstone/fastapi_rust/commit/8b2d2739f60370b0e7eba4cc5a7bf4d1a1d0b44f), [`870e903`](https://github.com/Dicklesworthstone/fastapi_rust/commit/870e903ca7646c8a0af06bb6af288b0bdce89f34))
...
- **Ping/pong handling** and upgrade+frames E2E tests ([`8afea7c`](https://github.com/Dicklesworthstone/fastapi_rust/commit/8afea7c889199a29311d4cf520fb79c965686b62), [`7e2bf41`](https://github.com/Dicklesworthstone/fastapi_rust/commit/7e2bf41a396a019a998ff4f269594e06c119b3d5))
- **Close parsing and RSV validation** hardened ([`9d4cf15`](https://github.com/Dicklesworthstone/fastapi_rust/commit/9d4cf158a6e4a5ec9bab4dbe8bef4decf4b53596), [`846cf63`](https://github.com/Dicklesworthstone/fastapi_rust/commit/846cf632b5f7ad81501f36cc968e512e581a2824))
...
Substantial HTTP/2 support added from the ground up:

- **h2c preface + HPACK** decoder and initial E2E test ([`564917f`](https://github.com/Dicklesworthstone/fastapi_rust/commit/564917fe9e41b7489e9ca6900d4fed1a34673e68))
...
- **SETTINGS validation**: RST_STREAM handling hardened, all RFC 7540 settings recognized ([`276b73e`](https://github.com/Dicklesworthstone/fastapi_rust/commit/276b73eaafa900f3c8da9e0eeb5c8cd47e9e0aad), [`a48e9db`](https://github.com/Dicklesworthstone/fastapi_rust/commit/a48e9db9b267ecf8e98078a9359f3bf8c61a4610))
- **Flow control**: RFC 7540 receive-side flow control with WINDOW_UPDATE emission ([`1993983`](https://github.com/Dicklesworthstone/fastapi_rust/commit/199398373a701c3e08065cdd6e5c1b44f1f476c5))
- **Send-side flow control** and GOAWAY frame support, wired into app/handler paths ([`6b5d281`](https://github.com/Dicklesworthstone/fastapi_rust/commit/6b5d2816a158cfeb0a8ea5b558411659ba3577ef), [`76667a8`](https://github.com/Dicklesworthstone/fastapi_rust/commit/76667a80ae5169ca06e91359bcb253dedb286c7f))
...
- **Split max_frame_size** into recv vs peer limits; honor dynamic peer max-frame-size ([`aa31156`](https://github.com/Dicklesworthstone/fastapi_rust/commit/aa311563c121ea622f1e69e39365b92dee9eafb2), [`b45da8d`](https://github.com/Dicklesworthstone/fastapi_rust/commit/b45da8d2b5926ba283494f268f542b7ad56eb77f))
...
- **Multipart parser**: initial implementation with size limits ([`d055e7e`](https://github.com/Dicklesworthstone/fastapi_rust/commit/d055e7e87b5c0b7bb02e4dabde06293e171b90b9))
- **Boundary detection hardened** ([`771adab`](https://github.com/Dicklesworthstone/fastapi_rust/commit/771adabce2d0d65d2b2567b2b0ba18a264f1dc16))
- **Streaming multipart parser, UploadFile async API, and temp-file spooling** ([`7af61f0`](https://github.com/Dicklesworthstone/fastapi_rust/commit/7af61f0b10454ae29a30b06c905eb0e9f2fcaec6))
...
- Full Digest auth implementation and extractor ([`3817c16`](https://github.com/Dicklesworthstone/fastapi_rust/commit/3817c16d6fe81a75c1a775e21f3f9f5ba5817821), [`0f2da2c`](https://github.com/Dicklesworthstone/fastapi_rust/commit/0f2da2c7e46fb0b95af3b3be8f0fec71a3f6aca5))

### Security Hardening -- `bd-uz2s`

- **Request smuggling prevention**: reject compound `Transfer-Encoding` ([`ee17294`](https://github.com/Dicklesworthstone/fastapi_rust/commit/ee17294c9b97d94de8cb1208089ff453edd43404))
...
- **Routing/middleware hardening**: path traversal, CORS, and injection protections ([`17b0976`](https://github.com/Dicklesworthstone/fastapi_rust/commit/17b0976a755d2eeacac2bd9e0d146fff47a8f87e))
- **Content-type validation, auth token limits, UTF-8 URL decoding** fixes ([`c95e148`](https://github.com/Dicklesworthstone/fastapi_rust/commit/c95e148519affe54ecaacdda5861e5af102acc4c))
...
- **Request parsing hardened** and missing handler path validation added ([`db2a892`](https://github.com/Dicklesworthstone/fastapi_rust/commit/db2a892e9926aa85168d3c416cfcade6ca4dd267))
- **Accept-Ranges token handling** tightened ([`7e5d624`](https://github.com/Dicklesworthstone/fastapi_rust/commit/7e5d62499e9c9f0c17a5fcd545f5b3e3dd375d8a))
- **Expect token list parsing** made robust ([`a761d5e`](https://github.com/Dicklesworthstone/fastapi_rust/commit/a761d5eaeb9cdf4c6768aeaca064018404162398))
- **Digest auth parsing** hardened (Content-Disposition, parameter extraction) ([`620ace1`](https://github.com/Dicklesworthstone/fastapi_rust/commit/620ace1f8e764ed750fdc7401a4b06533bd14cad))
- Regression test suites for all parsing hardening ([`e27818b`](https://github.com/Dicklesworthstone/fastapi_rust/commit/e27818ba31db16c35e8e4ed6e257c851faf950a0))
...
- **Tokio removal**: replaced with asupersync-only chunked streaming reads ([`cfe6b87`](https://github.com/Dicklesworthstone/fastapi_rust/commit/cfe6b87290a8647c4a8e576e8216056ac89ec043))
- **Misleading placeholders removed**: async chunked trailers fixed ([`d9afd91`](https://github.com/Dicklesworthstone/fastapi_rust/commit/d9afd91e474c5307c65a1bb060b90e5bb2694dfc))
...
- **Validation parity**: OpenAPI camelCase, body streaming fixes ([`926b824`](https://github.com/Dicklesworthstone/fastapi_rust/commit/926b824bed6b1e4f838976e26fd78f7384b0c5d4))
- **response_model options**: `by_alias`, `exclude_unset`, `exclude_defaults` made real ([`68376b7`](https://github.com/Dicklesworthstone/fastapi_rust/commit/68376b72492131e25eeffbcb92d321dcc07a64b7))
- **Pre-body validators** wired; multi-range parsing support ([`cf1eb95`](https://github.com/Dicklesworthstone/fastapi_rust/commit/cf1eb9507d600560b345db1dbcb3e8e927631bfd))
...
- **Route consolidation**: `Route::new` replaces `Route::with_placeholder_handler` ([`280bf6b`](https://github.com/Dicklesworthstone/fastapi_rust/commit/280bf6bcffb0ab899fc24d1160d7b9bd2c792494))
- **Coverage fix**: replace hand-built JSON with serde_json for correct escaping ([`9b836e0`](https://github.com/Dicklesworthstone/fastapi_rust/commit/9b836e038ece04a4a250bea8b0de9138b91925f1))
...
> **Diff from project start**: `1fbd93f..d12a9de` (~200 commits)

First public crates.io release. The crate was renamed from `fastapi` to `fastapi-rust` (Rust import name `fastapi_rust`) to avoid crate name conflicts.

### Crates.io Publish Logistics
...
> Rapid development phase: ~200 commits in 19 days building the framework from spec extraction through a comprehensive feature set.

### Project Bootstrap (2026-01-17)

- FastAPI spec extraction and Rust architecture design document ([`d87e360`](https://github.com/Dicklesworthstone/fastapi_rust/commit/d87e36008099c19911866610461ad336020eaab0))
...
- Workspace initialized: `fastapi-core`, `fastapi-http`, `fastapi-router`, `fastapi-macros`, `fastapi-openapi` crates ([`5cb282f`](https://github.com/Dicklesworthstone/fastapi_rust/commit/5cb282fc38078dff1bd9e7c718daa3807ff60653))

### Core Framework (2026-01-17 -- 2026-01-22)

- **Zero-copy HTTP/1.1 parser** with borrowed header types ([`5cb282f`](https://github.com/Dicklesworthstone/fastapi_rust/commit/5cb282fc38078dff1bd9e7c718daa3807ff60653), [`04ddd37`](https://github.com/Dicklesworthstone/fastapi_rust/commit/04ddd3700ec91cc8e6ac77b3a3190034fc897fb4))
...
- **Timing-safe comparison** utilities for security-critical comparisons ([`fe6a4a1`](https://github.com/Dicklesworthstone/fastapi_rust/commit/fe6a4a123095b2c7597d8a80119bb963865526f0))
...
- **Validation macros**: `#[derive(Validate)]` with email, phone, contains, starts_with, ends_with validators ([`b1b9c3f`](https://github.com/Dicklesworthstone/fastapi_rust/commit/b1b9c3f504a99f2f1839021328e12191bc1e449e), [`baa47d1`](https://github.com/Dicklesworthstone/fastapi_rust/commit/baa47d190b12f21ca45c4a972a2e18e7fcb16482))
- **`#[derive(JsonSchema)]`** with generic type support ([`3666ddf`](https://github.com/Dicklesworthstone/fastapi_rust/commit/3666ddfebf02ed5becb3d36d2ff589e5fccdd5fe))

### TCP Server and Middleware (2026-01-21 -- 2026-01-28)
...
- **Middleware system**: onion model execution with before/after hooks ([`349e201`](https://github.com/Dicklesworthstone/fastapi_rust/commit/349e20185fde046cc81bbe366f971f00f7dca5a1))
...
- **CSRF middleware** ([`867e8ae`](https://github.com/Dicklesworthstone/fastapi_rust/commit/867e8ae4df68362e365161efc97d3cfde72583ea))
...
- **RequestId middleware**, request/response logger ([`349e201`](https://github.com/Dicklesworthstone/fastapi_rust/commit/349e20185fde046cc81bbe366f971f00f7dca5a1))
...
- **Sub-application mounting** ([`f0ed512`](https://github.com/Dicklesworthstone/fastapi_rust/commit/f0ed51225f89eee8cf6c91a220a9d20bd71fe54a))
- **URL generation** / reverse routing ([`3199dce`](https://github.com/Dicklesworthstone/fastapi_rust/commit/3199dcec10d471e770fae5121442bfe325ac94bc))
...
- **Trie optimization** and route macro improvements ([`3dccce0`](https://github.com/Dicklesworthstone/fastapi_rust/commit/3dccce0c1c7611f30c13ca89e34f537d2a8941cc))

### Extractors (2026-01-22 -- 2026-01-28)
...
### Dependency Injection (2026-01-21 -- 2026-01-28)

- **Request-scoped DI** with caching (resolve once per request, or per call) ([`6e711b4`](https://github.com/Dicklesworthstone/fastapi_rust/commit/6e711b4f315752399da1146d7b88a5a03e8b6645))
- **Dependency override** integration for testing ([`64d94f3`](https://github.com/Dicklesworthstone/fastapi_rust/commit/64d94f3ee724d7099c014aa7883b2cd0cb064460))
- **Scope constraint validation** ([`7a53822`](https://github.com/Dicklesworthstone/fastapi_rust/commit/7a538221394ce2c92a35e14e494e920dc6a951d9))
- **Circular dependency detection** tests ([`63f5aa6`](https://github.com/Dicklesworthstone/fastapi_rust/commit/63f5aa61f12772436cf0a7b5c0892484a0716545))

### OpenAPI (2026-01-27 -- 2026-01-28)
...
- **Validation constraints** in schema ([`09ba510`](https://github.com/Dicklesworthstone/fastapi_rust/commit/09ba5101a710aaf06ed413b69b9b37a9dc65fed9))
...
### HTTP Features (2026-01-28 -- 2026-01-30)
...
- **Async streaming body readers** ([`f1905a9`](https://github.com/Dicklesworthstone/fastapi_rust/commit/f1905a9d859dc313404ca660169f36d3e646bc1a))
- **Link header builder** and pipelining tests ([`32379246`](https://github.com/Dicklesworthstone/fastapi_rust/commit/32379246c645b71e4eb6029aaea00ad6d8f401dc))
...
### Testing Infrastructure (2026-01-28 -- 2026-01-29)
...
### Security (2026-01-29 -- 2026-01-30)

- **CSRF token generation** fix (use CSPRNG, remove weak fallback) ([`6c6a55b`](https://github.com/Dicklesworthstone/fastapi_rust/commit/6c6a55b0938aa6813aaecd3afadf24dd7304479e), [`0237e83`](https://github.com/Dicklesworthstone/fastapi_rust/commit/0237e83600a069d85d96a9b1f033e37fe66b69de))
...
- **Password hashing**: reject invalid base64 instead of silently skipping ([`b8b6be8`](https://github.com/Dicklesworthstone/fastapi_rust/commit/b8b6be81bfd211bbff8f2f3059c423d3af5f2a91))
...
### Performance (2026-01-28 -- 2026-01-30)
...
- **Regex pattern caching** with `OnceLock` for validators ([`580ac53`](https://github.com/Dicklesworthstone/fastapi_rust/commit/580ac531b800ed1f384e3221a5966ff459dd1149))
...
- **Zero-copy header insertion** via `insert_from_slice` ([`f6089ec`](https://github.com/Dicklesworthstone/fastapi_rust/commit/f6089ec22788938a96738337808017a26245e283))
...
- Migrate from `std::sync::Mutex` to `parking_lot` across dependency, coverage, and testing modules ([`4ed3169`](https://github.com/Dicklesworthstone/fastapi_rust/commit/4ed316983e7d45e2c34b60a16ddb5064f93af370), [`c84c3c6`](https://github.com/Dicklesworthstone/fastapi_rust/commit/c84c3c6dbc7d75bbeda3a24935ec641e1c4bbaf9), [`697a09c`](https://github.com/Dicklesworthstone/fastapi_rust/commit/697a09cf7bace6e1c1cff8f91aabc8c80034af66))
...
- README with hero illustration, CI badges, quick example ([`361d1dc`](https://github.com/Dicklesworthstone/fastapi_rust/commit/361d1dca654258963e14087c84cd0ab0ebb0edcc), [`16d0050`](https://github.com/Dicklesworthstone/fastapi_rust/commit/16d0050c8525f826dde270fa8ec8826044046525))
